...
![展示了一个标有白键字母名称的钢琴键盘。标注了 B/C、E/F 之间的半音，以及 G 和升 G、A 和降 A 之间的半音。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch5-ex1-piano-half_steps-300x191.jpg)
示例 1.
...
![展示了一个钢琴键盘，白键已标注。标注了 A 和 B、E 和升 F、降 D 和降 E 之间的全音。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch5-ex2-piano-whole_steps-300x205.jpg)
示例 2.
...
![展示了绘制变音记号的正确和错误方式。正确的变音记号出现在音符左侧，与音符在同一行线或间上。错误的变音记号太大、太小，或在与音符不同的线或间上。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch5-ex4-accidental_placement-300x76.jpg)
示例 4.
绘制变音记号的正确和错误方式。

当两个音符出现在同一条线或同一个间但具有不同的变音记号时，变音记号分别适用于第一个和第二个音符。示例 5 展示了这一点：

![展示了一个高音谱号谱表。在两个 B 音之前有两个变音记号，一个降号和一个还原号。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/Same-Note-Two-Accidentals-e1750264867259.png)
示例 5.
降 B 和还原 B 并列。
...
![展示了一个钢琴键盘。白键和黑键都已标注。每个黑键音符都有升号和降号两个名称。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch5-ex5-piano-black_keys-300x227.jpg)
示例 6.
标有黑键字母名称的钢琴键盘。
...
![展示了一个钢琴键盘，白键和黑键都已标注。此外，一些白键上展示了重变音记号。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch5-ex6-double_accidentals-300x226.jpg)
示例 7.
钢琴键盘上的重变音记号。
