...
![展示了几个音符，标注了符头、符干、符杠和符尾](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/noteillustration-1-300x132.png)
示例 1.
标注了符头、符干、符杠和符尾的音符。
...
![展示了全音符、二分音符、四分音符、八分音符、十六分音符和三十二分音符之间关系的层级图形](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/durations-1-264x300.png)
示例 2.
常见音符时值之间的相对关系。
...
![展示了一条线上的倍全音符。](https://viva.pressbooks.pub/app/uploads/sites/12/2021/06/Example-3-Chapter-8-300x133.png)
示例 3.
一条线上的倍全音符。
...
![展示了全休止符、二分休止符、四分休止符、八分休止符、十六分休止符和三十二分休止符之间的层级关系](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/rests-1-264x300.png)
示例 4.
常见休止符时值之间的相对关系。

虽然很少见，但你可能会遇到二全休止符（breve rest，示例 5）。二全休止符的长度等于两个全休止符。它看起来像一个实心方框，出现在从上数第二个间中。

![谱表上出现一个二全休止符](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/Breve-Rest-300x139.png)
示例 5.
二全休止符。
...
![两个附点音符的示例，一个双附点音符的示例](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/dots-1-300x244.png)
示例 6.
两个附点音符和一个双附点音符的节奏分解。
