...
![钢琴键盘照片。既有白键也有黑键。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/Piano-Keyboard-300x211.jpg)
例1.
钢琴键盘的一小部分。
![扩展的钢琴键盘。黑键和白键均可见。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/Piano-Keyboard-Full-300x225.jpg)
例2.
钢琴键盘的较大部分。
...
![空白钢琴键盘，白键上标注了字母名称。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch4-ex4-white_keys_labeled-300x98.jpg)
例4.
白键音高的字母名称已标注。
...
![大谱表；连线和花括号已标注](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/brace_line-1-300x149.jpg)
例5.
大谱表通过一条线和一个花括号连接。

例6展示了标有字母名称的大谱表上的线和间。如你所见，高音谱号和低音谱号的线和间的字母名称与前一章（阅读谱号）中讨论的内容一致。

![大谱表和谱表上方的钢琴键盘。音符在钢琴键盘上标注，连线指向大谱表上对应的音符。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch4-ex6-grand_staff-labeled-300x116.jpg)
例6.
标有音高名称的大谱表上的线和间。

让我们仔细看一下可能出现在高音谱表下方和低音谱表上方的加线音符。例7展示了其中一些音符，用字母名称标注。每一对垂直排列的音符是相同的音高，即使它们分别在两种不同的谱号中记谱。（符干朝上的音符属于高音谱表，符干朝下的音符属于低音谱表。）

![低音谱表上方和高音谱表下方的音高。用字母名称D、C、B、A、G标注。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/Screen-Shot-2019-11-23-at-11.48.12-AM-300x180.png)
例7.
...
![谱表已垂直压缩。C音（中央C）被方框标注，位于高音谱号和低音谱号谱表之间。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch4-ex9-middle_c-1-300x124.jpg)
例9.
在垂直压缩的大谱表中，C音被方框标注。

例10展示了例9垂直扩展到正常间距后的效果，中央C仍被方框标注。虽然它现在同时出现在高音谱号和低音谱号的谱表中，但这个音符仍然发出相同的音高。

![大谱表已垂直扩展；中央C（在高音谱号和低音谱号中）已被方框标注](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/vertically_expanded_example_9-revised-300x109.jpg)
例10.
垂直扩展的例9。
...
![高音谱号谱表上F和C两个音符构成的五度。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch4-ex11-fifth-300x148.jpg)
例11.
五度的示例。
