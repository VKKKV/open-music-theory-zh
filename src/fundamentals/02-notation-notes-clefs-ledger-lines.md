...
![椭圆形符头的图示，部分为实心黑色，一个留空。还描绘了垂直的符干、水平的连梁和弯曲的符尾旗。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/noteillustration-1-300x132.png)
例 1.
符头、符干、连梁和符尾旗。
...
![五条等距的水平线。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/Staff-300x111.png)
例 2.
一个五线谱。
...
![正确符头的图示，包括空心（白色）和实心（黑色）。符头画在线上和间中。](https://viva.pressbooks.pub/app/uploads/sites/12/2022/07/Correct-Noteheads-300x58.jpg)
例 3.
正确的符头，空心（白色）和实心（黑色），在线上和间中。

符头应为椭圆形（不是圆形），并略微向右上方倾斜。例 4 展示了不正确的符头。[1] 如图所示，符头可能画得太小、太大或形状不对。

![不正确的符头示例。有些符头太小，有些太大，有些形状不对。描绘了线上和间中的符头，以及空心和实心符头。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/Incorrect-Noteheads-300x58.jpeg)
例 4.
不正确的符头示例。
...
![展示了带符干的音符。中间线以上，符干朝下，在音符左侧。中间线以下，符干朝上，在音符右侧。](https://viva.pressbooks.pub/app/uploads/sites/12/2022/07/Stemming-Directions-300x46.jpg)
例 5.
正确的符干方向。
...
![展示了三个二度音程。较低的音符总是在左边。](https://viva.pressbooks.pub/app/uploads/sites/12/2022/07/Correct-Seconds-1-e1657554954232.jpg)
例 6.
三个正确的二度音程。

二度音程不应上下叠放，较低的音符也不应在右边，如例 7 所示：

![展示了三个不正确的二度音程。一个是将两个音符直接上下叠放。另外两对音符中，右边的音符在下面。](https://viva.pressbooks.pub/app/uploads/sites/12/2022/07/Incorrect-Seconds-1-e1657554935561.jpg)
例 7.
三个不正确的二度音程。
...
![四个音符（C4）分别放在四种不同谱号之后：高音、低音、中音和次中音谱号。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/clefs-300x100.png)
例 8.
...
![高音谱号分三步绘制。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/DrawTrebleClef-300x69.png)
例 9.
分三步绘制高音谱号。
...
![低音谱号分三步绘制。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/DrawBassClef-300x63.png)
例 10.
分三步绘制低音谱号。
...
![中音谱号分四步绘制。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/DrawAltoClef-300x51.png)
例 11.
分四步绘制中音谱号。
...
![次中音谱号分四步绘制。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/11/DrawTenorClef-300x53.png)
例 12.
分四步绘制次中音谱号。

有时音乐家绘制中音或次中音谱号时，会用字母"K"作为一种速记方式。例 13 展示了这一点：

![手绘的中音和次中音谱号，形状像字母 K。](https://viva.pressbooks.pub/app/uploads/sites/12/2022/07/K-Clefs-300x76.jpg)
例 13.
使用字母"K"绘制中音和次中音谱号。
...
![描绘了一个带低音谱号的五线谱。五线谱上方和下方有加线。没有符头。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/ledger-lines-for-chelsey_0006-300x248.png)
例 14.
带低音谱号的五线谱上方和下方的加线。

例 15 展示了画在加线上的音符（带符干和连梁），位于五线谱的上方和下方。

![五线谱左侧有高音谱号。音符（带连梁和符干）放置在五线谱上方和下方的加线上。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/05/LedgerLineswithNotes-300x59.png)
例 15.
带高音谱号的五线谱上方和下方加线上的音符（带符干和连梁）。

书写加线时，确保不要在您正在书写的音符上方或下方放入多余的加线。例 16 首先展示了在加线上书写音符的正确方式，然后是不正确的方式，音符上下有多余的加线：[3]

![左边展示了正确绘制的加线和音符。右边展示了不正确绘制的加线。音符上方或下方不应有多余的加线。](https://viva.pressbooks.pub/app/uploads/sites/12/2019/12/ch2-ex13-ledger_lines-300x89.jpg)
例 16.
正确和不正确的加线记谱。
