...
![速度从最慢到最快排列在一条线上。依次为庄板、慢板、广板、柔板、行板、中板、小快板、快板、活泼和急板](https://viva.pressbooks.pub/app/uploads/sites/12/2020/02/tempi-300x27.png)
示例 8.
速度从最慢到最快排列。
...
![展示了贝多芬《致爱丽丝》的四小节片段。第三小节中有一个渐慢标记，第四小节中用"a tempo"标示回到原速。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/Fur-Elise-A-Tempo.png)
示例 9.
...
![展示了一个低音谱号谱表。一小节中的音符后跟一小节反复记号。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/Single-Measure-Repeat.png)
示例 15.
一小节反复记号。
![展示了一个低音谱号谱表。第一小节中的音符后跟两小节反复记号。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/Two-Measure-Repeat-300x95.png)
示例 16.
两小节反复记号。

你可能还会遇到其他几个结构标记，包括 D.C. al Coda、D.C. al Fine、D.S. al Coda 和 D.S. al Fine。这些结构标记使用两个符号，记住它们很有用。示例 17 展示了这些符号：

![展示了两个符号。左边的看起来像一个圆圈中间有一条竖线。右边的看起来像一个倾斜的 S 中间有一条对角线，带两个点。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/To-Coda-and-Segno-Sign.png)
示例 17.
...
![展示了高音谱号中的音乐。演奏或演唱音乐直到遇到 D.C. al Coda 标记。回到开头并演奏或演唱到"到尾声"符号。此时跳到尾声并演奏或演唱到结束。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/D.C.-al-Coda.png)
示例 18.
...
![展示了高音谱号中的音乐。演奏或演唱音乐直到遇到 D.C. al Fine 标记。回到开头并演奏或演唱到 Fine。](https://viva.pressbooks.pub/app/uploads/sites/12/2025/06/D.C.-al-Fine.png)
示例 19.
...
![时间线展示了中世纪、文艺复兴、巴洛克、古典、浪漫和后调性时期](https://viva.pressbooks.pub/app/uploads/sites/12/2020/02/96422265_232053788221736_2295624173914947584_n-300x34.png)
示例 20.
描绘音乐风格时期通常认可年份的时间线。
